  ...
  <div class="connections-page">
    ...
    <form class="connections-form">
      <div class="form-inline pr-1 pl-1 pt-1 pb-1">
        ...
        <!-- dst select -->
        <div class="form-group ml-1"
          v-if="fields && fields.length && dstFieldTypeahead">
          <div class="input-group input-group-sm">
            <span class="input-group-prepend legend cursor-help"
              v-b-tooltip.hover
              :title="$t('conns.dstTip')">
              <span class="input-group-text"
...
export default {
  ...
  computed: {
    ...
    fieldsInitialized: {
      get: function () {
        return this.$store.state.fieldsInitialized;
      },
      set: function (val) {
        this.$store.commit('setFieldsInitialized', val);
      }
    },
    nodeFields: function () {
  ...
  methods: {
      ...
      FieldService.get(true)
        .then((result) => {
          ...
          for (let field of this.fields) {
            ...
            // console.log('field.dbField', field.dbField, 'this.query.dstField', this.query.dstField);
    ...
    processData: function (json) {
      if (!json.nodes) {
        this.error = this.$t('conns.noNodeErr');
        return;
      }
