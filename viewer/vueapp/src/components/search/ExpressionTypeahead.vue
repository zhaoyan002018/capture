  ...
  <div class="mb-1">
    ...
    <div class="input-group input-group-sm">
      <span class="input-group-prepend input-group-prepend-fw cursor-help"
        ...
        :title="$t('expressionTypeahead.searchExpressionTip')">
      ...
      <input type="text"
        ...
        :placeholder="$t('expressionTypeahead.searchTip')"
        @blur="onOffFocus"
...
export default {
  ...
  methods: {
    ...
    changeExpression: function () {
      ...
      console.log('caretPos', this.caretPos, 'this.expression', this.expression.length);
