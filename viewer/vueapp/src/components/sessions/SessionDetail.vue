          ...
          <div class="form-group">
            <div class="input-group input-group-sm mb-1 mr-1">
              <span class="input-group-prepend cursor-help"
                v-b-tooltip
                :title="$t('sessions.sdLoadingTip2')">
            ...
            <div class="btn-group mr-1 mb-1"
              ...
              <button v-for="(value, key) in decodings"
                ...
                v-b-tooltip.hover
                :title="$t('sessions.sdListDecodingTip',[value.name])"
  ...
  methods: {
    ...
    cancelPacketLoad: function () {
      if (this.packetPromise) {
        ...
        this.errorPackets = this.$t('sessions.errorPacketsTip');
      }
    },
        ...
        .then((responses) => {
          ...
          new Vue({
            ...
            propsData: {
              ...
              fields: this.fields,
              dpsclusters: responses[1]
            },
            props: [ 'session', 'fields', 'dpsclusters' ],
            data: function () {
              return {
                form: undefined,
                cluster: undefined,
