        ...
        <thead>
          <tr ref="draggableColumns">
            ...
            <th class="ignore-element"
              ...
              <b-dropdown
                ...
                <b-dropdown-header>
                  <input type="text"
                    ...
                    :placeholder="$t('sessions.sSfcTip')"
                  />
                </b-dropdown-header>
                <b-dropdown-divider>
                </b-dropdown-divider>
              ...
              <b-dropdown
                ...
                <b-dropdown-header>
                  <div class="input-group input-group-sm">
                    <input type="text"
                      ...
                      :placeholder="$t('sessions.sEnccnameTip')"
                ...
                <b-dropdown-item
                  ...
                  :title="$t('sessions.sRttdColTip')">
                  {{$t('sessions.DpsDefault')}}
                </b-dropdown-item>
                <b-dropdown-item
            ...
            <button type="button"
              ...
              @click="fitTable"
              v-b-tooltip.hover
              :title="$t('sessions.sFtttCurWSize')">
  ...
  methods: {
    ...
    saveColumnConfiguration: function () {
      if (!this.newColConfigName) {
        this.colConfigError = this.$t('sessions.sColConfigError');
        return;
      }
    ...
    setupUserSettings: function () {
      ...
      if (!this.user.settings.manualQuery ||
        ...
        this.loading = false;
        this.error = this.$t('sessions.sError');
      }
    ...
    openAll: function () {
      ...
      if (this.sessions.data.length > 10) {
        alert(this.$t('sessions.sAlertErr'));
      }
