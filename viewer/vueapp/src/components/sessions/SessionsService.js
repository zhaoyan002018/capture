...
export default {
  ...
  get: function (query, url) {
    return new Promise((resolve, reject) => {
      ...
      if (query) {
        ...
        if (query.dataTerm) { params.dataTerm = query.dataTerm; }
  ...
  openSpiGraph: function (dbField, routeParams) {
    ...
    let url = `spigraph/spigraphindex?${qs.stringify(clonedParams)}`;
