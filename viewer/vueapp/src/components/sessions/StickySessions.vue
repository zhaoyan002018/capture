          ...
          <li class="list-group-item list-group-header">
            ...
            <span v-if="sortBy">
              <a v-if="sortOrder === 'asc'"
                ...
                :title="$t('sessions.ssSortingTip1')"
                class="btn btn-default btn-sm pull-right ml-1">
              ...
              <a v-if="sortOrder === 'desc'"
                v-b-tooltip.hover
                @click="toggleSortOrder"
                :title="$t('sessions.ssSortingTip2')"
                class="btn btn-default btn-sm pull-right ml-1">
            ...
            <select v-model="sortBy"
              ...
              <option disabled value="">
                {{$t('sessions.ssSortedBy')}}
              </option>
              <option value="firstPacket">
                {{$t('sessions.ssStartTime')}}
              </option>
              <option value="lastPacket">
                {{$t('sessions.ssStopTime')}}
              </option>
            </select>
            <h4>
              {{$t('sessions.ssOpenSession',[sessions.length,sessions.length > 1?'s' : ''])}}
            </h4>
          </li>
