      ...
      <div v-if="!dataLoading">
        ...
        <b-dropdown
          ...
          <template slot="button-content">
            <span class="fa fa-columns"
              v-b-tooltip.hover
              :title="$t('spiview.saveOrLoadHint')">
            </span>
          </template>
          <b-dropdown-header>
            <div class="input-group input-group-sm">
              <input type="text"
                ...
                :placeholder="$t('spiview.newFieldConfigNameHolder')"
          ...
          <b-dropdown-item
            ...
            :title="$t('spiview.resetFieldHint')">
            {{$t('spiview.DpsDefault')}}
          </b-dropdown-item>
          <b-dropdown-item
        ...
        <small>
          <strong class="ml-2 text-theme-accent"
            ...
            {{$t('spiview.showEntriesTip',[filtered ,total])}}
          </strong>
        </small>
      </div>
      <div v-if="dataLoading"
                ...
                <div class="btn-container">
                  <form class="form-inline">
                    <input type="text"
                      ...
                      :placeholder="$t('spiview.searchCTip')"
                      ...
                      <span v-for="field in categoryObjects[category].filteredFields"
                        ...
                        <b-dropdown split
                          ...
                          <b-dropdown-item
                            ...
                            {{$t('spiview.exportTip',[field.friendlyName])}}
                          </b-dropdown-item>
                          <b-dropdown-item
                            @click="exportUnique(field.dbField, 1)">
                            {{$t('spiview.exportWithCountTip',[field.friendlyName])}}
                          </b-dropdown-item>
                          <b-dropdown-item
                            @click="openSpiGraph(field.dbField)">
                            {{$t('spiview.oiSpiG',[field.friendlyName])}}
                          </b-dropdown-item>
                        </b-dropdown>
                      </span>
                    </template>
                ...
                <div v-for="(value, key) in categoryObjects[category].spi"
                  ...
                  <b-dropdown
                    ...
                    <b-dropdown-item
                      ...
                      {{$t('common.hide')}} {{ value.field.friendlyName }}
                    </b-dropdown-item>
                    <b-dropdown-item
                      @click="exportUnique(value.field.dbField, 0)">
                      {{$t('spiview.exportTip',[value.field.friendlyName])}}
                    </b-dropdown-item>
                    <b-dropdown-item
                      @click="exportUnique(value.field.dbField, 1)">
                      {{$t('spiview.exportWithCountTip',[value.field.friendlyName])}}
                    </b-dropdown-item>
                    <b-dropdown-item
                      @click="openSpiGraph(value.field.dbField)">
                      {{$t('spiview.oiSpiG',[value.field.friendlyName])}}
                    </b-dropdown-item>
  ...
  methods: {
    ...
    saveFieldConfiguration: function () {
      if (!this.newFieldConfigName) {
        this.fieldConfigError = this.$t('spiview.errorTip');
        return;
      }
