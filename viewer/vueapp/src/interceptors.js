...
export default function setup () {
  ...
  axios.defaults.xsrfCookieName = 'DPS-COOKIE';
  axios.defaults.xsrfHeaderName = 'X-DPS-COOKIE';
  ...
  axios.interceptors.response.use(function (response) {
    ...
    if (response.headers['x-dps-response-time']) {
      store.commit('setResponseTime', response.headers['x-dps-response-time']);
    }
    return response;
  }, function (error) {
